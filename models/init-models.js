...
var _dat_land_plots_old = require("./dat_land_plots_old");
...
function initModels(sequelize) {
  ...
  var dat_land_plots_old = _dat_land_plots_old(sequelize, DataTypes);
  ...
  dat_land_plots_old.belongsTo(mas_district, { as: "mas_dist", foreignKey: "mas_dist_id"});
  mas_district.hasMany(dat_land_plots_old, { as: "dat_land_plots_olds", foreignKey: "mas_dist_id"});
  dat_land_plots.belongsTo(mas_layer_groups, { as: "group_layer", foreignKey: "group_layer_id"});
  mas_layer_groups.hasMany(dat_land_plots, { as: "dat_land_plots", foreignKey: "group_layer_id"});
  dat_land_plots_old.belongsTo(mas_layer_groups, { as: "mas_layer_group", foreignKey: "mas_layer_group_id"});
  mas_layer_groups.hasMany(dat_land_plots_old, { as: "dat_land_plots_olds", foreignKey: "mas_layer_group_id"});
  ...
  dat_land_plots_old.belongsTo(mas_province, { as: "mas_prov", foreignKey: "mas_prov_id"});
  mas_province.hasMany(dat_land_plots_old, { as: "dat_land_plots_olds", foreignKey: "mas_prov_id"});
  ...
  dat_land_plots_old.belongsTo(mas_subdistrict, { as: "mas_subdist", foreignKey: "mas_subdist_id"});
  mas_subdistrict.hasMany(dat_land_plots_old, { as: "dat_land_plots_olds", foreignKey: "mas_subdist_id"});
  dat_land_plots.belongsTo(sysm_users, { as: "user", foreignKey: "user_id"});
  sysm_users.hasMany(dat_land_plots, { as: "dat_land_plots", foreignKey: "user_id"});
  dat_land_plots_old.belongsTo(sysm_users, { as: "created_by_sysm_user", foreignKey: "created_by"});
  sysm_users.hasMany(dat_land_plots_old, { as: "dat_land_plots_olds", foreignKey: "created_by"});
  dat_land_plots_old.belongsTo(sysm_users, { as: "updated_by_sysm_user", foreignKey: "updated_by"});
  sysm_users.hasMany(dat_land_plots_old, { as: "updated_by_dat_land_plots_olds", foreignKey: "updated_by"});
